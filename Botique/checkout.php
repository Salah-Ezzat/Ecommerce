...
if (!isset($_POST['names'])){
  header("location:detail.php?alert=alert");
  exit;
};
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    ?>
                    <li class="d-flex align-items-center justify-content-between"><strong class="small font-weight-bold"><?=$name[$i]?></strong><span class="text-muted small">$<?=$price[$i]?></span></li>
                    <li class="border-bottom my-2"></li>
                    <?php }?>
                    <li class="border-bottom my-2"></li>
                    <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small font-weight-bold">Total</strong><span>$<?=$sumTotal?></span></li>
                  </ul>
                </div>
              </div>
            </div>
